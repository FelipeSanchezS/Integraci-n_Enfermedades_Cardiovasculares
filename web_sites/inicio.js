...
(async () => {
    ...
    console.log("Se carga el modelo V5");
    modelo = await tf.loadLayersModel("../red_entrenada/model.json");
    console.log("Se cargoooo la red neuronal V5");
...
botom.onclick = () =>{
    ...
    if(modelo != null){
        ...
        var ten = tf.tensor2d([[parseInt(saludg), parseInt(chequeo), parseInt(ejercicio),
            ...
            parseInt(sexo), parseInt(edad), parseInt(peso), parseInt(imc), parseInt(altura), parseInt(tabaquismo),
